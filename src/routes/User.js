...
AuthRoute.put('/user/upload/:userId', uploads.upload.single('image'), Uploads.uploadImage);
AuthRoute.get('/user/avatar/:userId', Uploads.getAvatar);
AuthRoute.get('/user/getAvatar/:imageId',Uploads.getImage);
// AuthRoute.put('/user/uploads',uploads.upload.single('image'),Uploads.uploadImage2);
